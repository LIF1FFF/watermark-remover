...
import { get, post, parseJSON, extract, MOBILE_UA, PC_UA } from '../http.js';
...
async function parse(input, ctx = {}) {
  ...
  // 第三方兜底由入口统一处理（见 lib/parsers/index.js）
  throw new Error('抖音解析失败：官方接口风控较严，可尝试换用 App 分享的完整链接');
}

export { match, parse };
export const name = '抖音';
